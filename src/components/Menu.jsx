const Menu = () => {
  return (
    <div className="flex max-w-xl p-10 mx-auto my-5 text-center">
      <div className="flex-col text-center bg-white rounded ring-2 ring-boba-cream py-4 px-10">
        <h3 className="text-[35px] font-bold font-Playfair-Display mb-2 mt-5">
          TarosBobaBar Menu
        </h3>
        <div className="border rounded-full border-boba-cream"></div>
        <div className="flex flex-col my-10">
          <div className="flex">
            <h3 className="font-bold text-2xl mb-5 mx-auto">Milk Teas</h3>
          </div>
            ...
            <li className="flex">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-md text-left ml-5">
                  A delicate blend of fragrant jasmine tea and creamy milk for a
                  soothing, aromatic experience that transcends the ordinary.
                </p>
              </div>
            </li>
            <li className="flex">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-md text-left ml-5">
                  ...
                  full-bodied beverage, a perfect harmony of flavor and comfort.
                </p>
              </div>
            </li>
            <li className="flex">
        ...
        <div className="mx-auto border rounded-full border-boba-cream w-4/5"></div>
        <div className="flex flex-col my-10">
          <div className="flex">
            <h3 className="font-bold text-2xl mb-5 mx-auto">Fruit Teas</h3>
          </div>
          <ul className="grid grid-cols-1 gap-5 items-center">
            <li className="flex">
              <h5 className="text-bold text-[20px] text-left mr-3">1.</h5>
              <div className="flex flex-col">
                ...
                <p className="text-md text-left ml-5">
                  ...
                  exotic sweetness of lychee—a harmonious blend that&pos;s both
            ...
            <li className="flex">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-md text-left ml-5">
                  ...
                  tea leaves, creating a vibrant and refreshing tropical escape.
                </p>
              </div>
            </li>
            <li className="flex">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-md text-left ml-5">
                  Juicy peach essence meets perfectly brewed tea for a blissful,
                  refreshing sip.
                </p>
              </div>
            </li>
        ...
        <div className="flex flex-col my-10">
          <div className="flex">
            <h3 className="font-bold text-xl mb-5 mx-auto">Toppings</h3>
          </div>
